...
public class BoardStaff {
    ...
    public BoardStaff(SimpleIntegerProperty staff_id, SimpleStringProperty staff_name, SimpleStringProperty staff_address, SimpleIntegerProperty contact_no, SimpleIntegerProperty salary) {
